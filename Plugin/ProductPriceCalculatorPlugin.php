...
namespace Blackbird\RoundedDiscountPrice\Plugin;

use Blackbird\RoundedDiscountPrice\Model\Rule\Action\RoundingTypeProvider;
 ...
 * @package Blackbird\RoundedDiscountPrice\Plugin
 **/
class ProductPriceCalculatorPlugin
{
